...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Farhan\n'
            + 'ORG:Creator FXC7;\n'
            + 'TEL;type=CELL;type=VOICE;waid=5515998299693:+55 15 99829-9693\n'
            + 'END:VCARD'

prefix = "_"
name = "~ MEDUSA | B O T"
rdaftar = "OBRIGADO POR SE REGISTRAR😁"
rmenu = "Olá amigos do MEDUSABOT👋"
limitt = 50
ban = []
userpremium = ["5515998299693@s.whatsapp.net","5588998368395@s.whatsapp.net"] //ubah nomer kalian
...
const getRegisteredRandomId = () => {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const FarhanGans = ["5515998299693@s.whatsapp.net"] // apenas mude esta tudo bem
			...
			const ownerNumber = ["5515998299693@s.whatsapp.net","5588998368395@s.whatsapp.net"] // owner number ubah aja
		...
		case 'daftar':
         ...
         case 'lirik':
                ...
                if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('5515998299693@s.whatsapp.net', options, text, {quoted: mek})
