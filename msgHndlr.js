...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = ["558898368395@c.us","558898368395"] // replace with your whatsapp number
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '558898368395@c.us')
            break
        case '!ig':
        ...
        case '!demote':
            ...
            break
        case '!join':
            //return client.reply(from, 'Jika ingin meng-invite bot ke group anda, silahkan izin ke wa.me/558898368395', id)
